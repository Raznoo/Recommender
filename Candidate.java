...
//    @Override
//    public LinkedList<String> getAttributesDatum() {
//        LinkedList<String> list = new LinkedList<String>();//is name an attribute?
//        list.addLast("gender");
//        list.addLast("leadershipExperience");
//        list.addLast("lastPositionDuration");
//        list.addLast("numWorkExperiences");
//        list.addLast("programmingLanguages");
//        list.addLast("gpa");
